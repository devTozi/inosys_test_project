...
if (!nexacro._CellControl) {
	...
	_pCellButton._getComputedStyle = function () {
		...
		new Function("ctrl_cs", "str", "ctrl_cs.styles = str")(ctrl_cs, str);
	...
	_pCellBar._getComputedStyle = function () {
		...
		if (this.progressbaritem) {
			...
			new Function("ctrl_cs", "str", "ctrl_cs.progressbaritem.styles = str")(ctrl_cs, str);
		}
		if (this.progressbartext) {
			...
			new Function("ctrl_cs", "str", "ctrl_cs.progressbartext.styles = str")(ctrl_cs, str);
		}
		if (this.progressstartcap) {
			str = nexacro._getComputedStyleProperties(this.progressstartcap._control_element, properties, null, true);
			new Function("ctrl_cs", "str", "ctrl_cs.progressstartcap.styles = str")(ctrl_cs, str);
		}
		if (this.progressendcap) {
			str = nexacro._getComputedStyleProperties(this.progressendcap._control_element, properties, null, true);
			new Function("ctrl_cs", "str", "ctrl_cs.progressendcap.styles = str")(ctrl_cs, str);
		}
		return ctrl_cs;
	};
	...
	_pCellTextArea._getComputedStyle = function () {
		...
		if (this.hscrollbar) {
			...
			new Function("ctrl_cs", "str", "ctrl_cs.hscrollbar.styles = str")(ctrl_cs, str);

			str = nexacro._getComputedStyleProperties(this.hscrollbar.decbutton._control_element, properties, null, true);
			new Function("ctrl_cs", "str", "ctrl_cs.hscrollbar.decbutton.styles = str")(ctrl_cs, str);
	...
	_pCellCalendar._getComputedStyle = function () {
		...
		if (this.calendaredit) {
			...
			new Function("ctrl_cs", "str", "ctrl_cs.calendaredit.styles = str")(ctrl_cs, str);
		}
		if (this.dropbutton) {
			str = nexacro._getComputedStyleProperties(this.dropbutton._control_element, properties, null, true);
			new Function("ctrl_cs", "str", "ctrl_cs.dropbutton.styles = str")(ctrl_cs, str);
		}
		if (this.calendarspinupbutton) {
			...
			new Function("ctrl_cs", "str", "ctrl_cs.calendarspinupbutton.styles = str")(ctrl_cs, str);
		}
		if (this.calendarspindownbutton) {
			...
			new Function("ctrl_cs", "str", "ctrl_cs.calendarspindownbutton.styles = str")(ctrl_cs, str);
		}
	...
	_pCellCombo._getComputedStyle = function () {
		...
		if (this.comboedit) {
			...
			new Function("ctrl_cs", "str", "ctrl_cs.comboedit.styles = str")(ctrl_cs, str);
		}
		if (this.dropbutton) {
			str = nexacro._getComputedStyleProperties(this.dropbutton._control_element, properties, null, true);
			new Function("ctrl_cs", "str", "ctrl_cs.dropbutton.styles = str")(ctrl_cs, str);
